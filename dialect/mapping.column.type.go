...
var openGaussColumnTypeList = []*ColumnTypeInfo{
	{Name: `TINYINT`, Format: `TINYINT`, Matches: []string{`NUMBER&&columnScale==0&&((columnLength>0&&columnLength<3)||(columnPrecision>0&&columnPrecision<3))`, `INT1`, `BOOL`, `BOOLEAN`}, IsNumber: true, IsInteger: true, Comment: `1 Bytes 范围（有符号）(-128，127) 范围（无符号）(0，255) 小整数值`},
	{Name: `SMALLINT`, Format: `SMALLINT`, Matches: []string{`NUMBER&&columnScale==0&&((columnLength>0&&columnLength<6)||(columnPrecision>0&&columnPrecision<6))`, `INT2`}, IsNumber: true, IsInteger: true, Comment: `2 Bytes 范围（有符号）(-32 768，32 767) 范围（无符号）(0，65 535)  大整数值`},
	{Name: `MEDIUMINT`, Format: `MEDIUMINT`, Matches: []string{`NUMBER&&columnScale==0&&((columnLength>0&&columnLength<9)||(columnPrecision>0&&columnPrecision<9))`}, IsNumber: true, IsInteger: true, Comment: `3 Bytes 范围（有符号）(-8 388 608，8 388 607) 范围（无符号）(0，16 777 215)  大整数值`},
	{Name: `INT`, Format: `INT`, Matches: []string{`NUMBER&&columnScale==0&&((columnLength>0&&columnLength<11)||(columnPrecision>0&&columnPrecision<11))`, `INT4`}, IsNumber: true, IsInteger: true, Comment: `4 Bytes 范围（有符号）(-2 147 483 648，2 147 483 647) 范围（无符号）(0，4 294 967 295)  大整数值`},
